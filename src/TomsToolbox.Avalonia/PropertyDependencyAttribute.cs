namespace TomsToolbox.Avalonia;
...
public sealed class PropertyDependencyAttribute : Attribute
{
    ...
    /// <exception cref="InvalidOperationException">Invalid dependency definitions, i.e. dependency to non-existing property.</exception>
